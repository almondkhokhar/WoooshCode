...
void airplaneSkills(){
  Inertial.setRotation(82, deg);// do this in preauto
  Drive.move(-1000, .6);
  Drive.turn(87, .4);
  Drive.move(30, .8);
  Drive.turn(-30, .7);
  rDropDown.open();
  kicker.spin(fwd, 70, pct);
  kicker2.spin(fwd, 70, pct);
